...
[Icons]
Name: "{group}\6人の料理人と隻眼の少女2"; Filename: "{app}\6chefs2_1.3.exe"
Name: "{commondesktop}\6人の料理人と隻眼の少女2"; Filename: "{app}\6chefs2_1.3.exe"; WorkingDir: "{app}"; Tasks: desktopicon

[Languages]
Name:"jp";MessagesFile:"C:\Program Files (x86)\Inno Setup 5\Languages\Japanese.isl";

[Run]
Filename: "{app}\6chefs2_1.3.exe"; Description: "インストーラ終了時にゲームを起動する"; Flags: postinstall
